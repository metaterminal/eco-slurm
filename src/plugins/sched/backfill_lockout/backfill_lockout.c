...
/* calculates the current time of day in this timezone and 
returns true if in "off peak time" */
static bool off_peak(void) 
{
	time_t now;
	...
	// in the summer, off-peak is 2pm - 6am
	if ((curr_hour < 6) || (curr_hour >= 14)) {
		return true;
	}
